...
public class C08_SwitchStatements {
    public static void main(String[] args) {
        ...
        //Soru 6- Kullanicidan ay numarasini Ay ismini yazdirin.

        Scanner scanner = new Scanner(System.in);

        System.out.println("Yazdirmak istediginiz ayin kacinci ay");
        ...
        else System.out.println("Ay Numarasini Yanlis Girdiniz.");
