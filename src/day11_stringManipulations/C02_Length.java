...
public class C02_Length {
    public static void main(String[] args) {
        ...
        System.out.println("yazdiğiniz, " +girilenIsim + " isminin length'i, yani uzunluğu, "+ uzunluk + " dir." );

        if (uzunluk % 2 == 0){ // uzunluk ciftse ortadaki, iki harfi, uzunluğun yarısı olan indeksten önceki
