...
public class C03_ListMethodlar {
    public static void main(String[] args) {
        ...
        System.out.println(sayilar.get(1)); // verilen indeksteki elementi türkçe döndürür. 5

        System.out.println(sayilar.contains(3)); // true- sayiler arratList'i 3 elementini içerir mi ?
        ...
        System.out.println(tumSayilar.containsAll(sayilar)); // tumsayiların tamamı sayiları içeriyor mu TRUE
