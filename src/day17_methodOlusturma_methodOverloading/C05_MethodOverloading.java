...
public class C05_MethodOverloading {
    public static void main(String[] args) {
        ...
        /*
            ...
            4- minumum casting
         */
        toplama('s'); // tek int girilirse 2 kati yazilir : 230 // charın ascii değerinden
    ...
    public static void toplama(double b , int a){System.out.println("double ve int'in toplami : " +(a+b));
    }
